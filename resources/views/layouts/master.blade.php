        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    <li><a href="{{ url('/admin/showUsers') }}">Tutti gli Utenti</a></li>
                    <li><a href="{{ url('/admin/create') }}">Crea un Utente</a></li>
                    <li><a href="{{ url('/admin/showIngredients') }}">Tutti gli ingredienti</a></li>
                </ul>
